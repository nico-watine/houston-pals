...
<section class="grid-x grid-padding-x page-intro">
	<div class="cell medium-offset-1 medium-shrink">
		...
		<div class="prose">
			...
			<a href="/products.php" class="h5"><strong>Learn more about our products.</strong></a>
		</div>
	</div>
</section>
...
<div class="row">
	<div class="columns">
			...
			<li class="accordion-item" data-accordion-item>
				...
				<div class="accordion-content text-center" data-tab-content id="tailored-finish">
					...
					<div class="tailored-finish-options is-hidden grid-x small-up-3 medium-up-5" id="front-prosthetic-tailored-finish-option">
						...
						<!-- 1025 -->
						<div class="front-prosthetic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/front/prosthetic/front-prosthetic-1025.png')"><img class="circle" src="/img/product-builder/tailored-finish/1025.png" alt=""><p>2</p></span>
						</div>
						<!-- 1026 -->
						<div class="front-prosthetic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/front/prosthetic/front-prosthetic-1026.png')"><img class="circle" src="/img/product-builder/tailored-finish/1026.png" alt=""><p>3</p></span>
						</div>
						<!-- 1050 -->
						<div class="front-prosthetic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/front/prosthetic/front-prosthetic-1050.png')"><img class="circle" src="/img/product-builder/tailored-finish/1050.png" alt=""><p>4</p></span>
						</div>
						<!-- 1053 -->
						<div class="front-prosthetic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/front/prosthetic/front-prosthetic-1053.png')"><img class="circle" src="/img/product-builder/tailored-finish/1053.png" alt=""><p>5</p></span>
						</div>
						<!-- 1060 -->
						<div class="front-prosthetic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/front/prosthetic/front-prosthetic-1060.png')"><img class="circle" src="/img/product-builder/tailored-finish/1060.png" alt=""><p>6</p></span>
						</div>
						<!-- 1071 -->
						<div class="front-prosthetic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/front/prosthetic/front-prosthetic-1071.png')"><img class="circle" src="/img/product-builder/tailored-finish/1071.png" alt=""><p>7</p></span>
						</div>
						<!-- 1083 -->
						<div class="front-prosthetic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/front/prosthetic/front-prosthetic-1083.png')"><img class="circle" src="/img/product-builder/tailored-finish/1083.png" alt=""><p>8</p></span>
						</div>
						<!-- 1090 -->
						<div class="front-prosthetic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/front/prosthetic/front-prosthetic-1090.png')"><img class="circle" src="/img/product-builder/tailored-finish/1090.png" alt=""><p>9</p></span>
						</div>
						<!-- 1201 -->
						<div class="front-prosthetic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/front/prosthetic/front-prosthetic-1201.png')"><img class="circle" src="/img/product-builder/tailored-finish/1201.png" alt=""><p>10</p></span>
						</div>
					</div>
					<!-- Rear Orthotic -->
					<div class="tailored-finish-options is-hidden grid-x small-up-3 medium-up-5" id="rear-orthotic-tailored-finish-option">
						...
						<!-- 1025 -->
						<div class="rear-orthotic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/rear/orthosis/rear-orthosis-1025.png')"><img class="circle" src="/img/product-builder/tailored-finish/1025.png" alt=""><p>2</p></span>
						</div>
						<!-- 1026 -->
						<div class="rear-orthotic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/rear/orthosis/rear-orthosis-1026.png')"><img class="circle" src="/img/product-builder/tailored-finish/1026.png" alt=""><p>3</p></span>
						</div>
						<!-- 1050 -->
						<div class="rear-orthotic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/rear/orthosis/rear-orthosis-1050.png')"><img class="circle" src="/img/product-builder/tailored-finish/1050.png" alt=""><p>4</p></span>
						</div>
						<!-- 1053 -->
						<div class="rear-orthotic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/rear/orthosis/rear-orthosis-1053.png')"><img class="circle" src="/img/product-builder/tailored-finish/1053.png" alt=""><p>5</p></span>
						</div>
						<!-- 1060 -->
						<div class="rear-orthotic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/rear/orthosis/rear-orthosis-1060.png')"><img class="circle" src="/img/product-builder/tailored-finish/1060.png" alt=""><p>6</p></span>
						</div>
						<!-- 1071 -->
						<div class="rear-orthotic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/rear/orthosis/rear-orthosis-1071.png')"><img class="circle" src="/img/product-builder/tailored-finish/1071.png" alt=""><p>7</p></span>
						</div>
						<!-- 1083 -->
						<div class="rear-orthotic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/rear/orthosis/rear-orthosis-1083.png')"><img class="circle" src="/img/product-builder/tailored-finish/1083.png" alt=""><p>8</p></span>
						</div>
						<!-- 1090 -->
						<div class="rear-orthotic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/rear/orthosis/rear-orthosis-1090.png')"><img class="circle" src="/img/product-builder/tailored-finish/1090.png" alt=""><p>9</p></span>
						</div>
						<!-- 1201 -->
						<div class="rear-orthotic-tailored-finish-option cell option-cell">
							<span onclick="getElementById('tailored-finish-img').src=('/img/product-builder/rear/orthosis/rear-orthosis-1201.png')"><img class="circle" src="/img/product-builder/tailored-finish/1201.png" alt=""><p>10</p></span>
						</div>
					</div>
					<!-- Rear Prosthetic -->
		...
		<h4 class="text-center pt-40 pb-40" style="text-decoration: underline;"><a href="/ordering-product-faq.php"><strong>Learn how to begin your order.</strong></a></h4>
	</div>
</div>
