			...
			<div class="row pt-40 pb-40">
				<div class="columns medium-10 medium-push-1 large-8 large-push-2 end">
					<div class="build-a-brace-callout">
						...
						<p>Generate your pet's injury solution design with our unique <a class="inline-block" style="display: inline-block;text-decoration: underline;" href="/build-a-brace.php"><strong>Build-A-Brace</strong></a> tool. Choose from 10 different options.</p>
					</div>
				</div>
			</div>
