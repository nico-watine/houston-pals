				...
				<div class="grid-x grid-padding-x">
					...
					<div class="cell">
						<div class="grid-x grid-padding-x align-center align-middle">
							<div class="cell shrink">
								<div class="prose" style="width: 570px;">
									<p class="lead">Because of the success of Bill’s injury-solution limb for Will, <strong>Animal Planet</strong> reached out, asking for Will’s participation in <strong>Puppy Bowl 2019</strong>! Will, weighing a healthy 50 pounds, was too large to travel in the cabin of an airplane, so he and Bill set off on an exciting road trip to get him to New York, in time for the filming of Puppy Bowl 2019.</p>
								</div>
							</div>
							<div class="cell shrink">
								<img src="/img/partners/animal-planet-logo.png" style="width: 300px;" alt="">
							</div>
						</div>
					</div>
				</div>
